...
<br>
	  <div class="row">
			<div class="columns small-6 medium-3 large-3">
			  <div class="sm_circles">
				<a href="html/contact.php"><img id="social_media_icons"  src="assets/social_media/email-icon.png"><br>
	...
	<script>
		...
		// 	//bind 'subscribe-form' and provide a simple callback function

		// 	$('#subscribe-form').on(function() {
		// 	    alert("Thank you!");
		// 	});
		// });
	</script>
