  ...
  <br>
      ...
      <div class="row">
          ...
          <div class="columns small-12 medium-8 large-5" style="left:80px; top:65px;" >
                ...
                <br>
                <br>
                  <p style="text-align:left; margin-left: 25px; max-width: 85%;">Pack Your Back is a nonprofit organization that was started in a dorm room in Calkins Hall. It’s a few students at CMU who decided that they wanted to be hands on, they wanted to be proactive in helping the younger generation succeed. With that, Pack Your Back was born.</p>
                  <br>                         <p style="text-align:left; margin-left: 25px; max-width: 85%;">In January 2016, Galen Miller was volunteering in Flint with his fraternity. As they continued to deliver water and other supplies to the residents suffering from the water crisis, Miller noticed that as the major media outlets began to leave, so did the help.</p>
                  <br>
                <p style="text-align:left; margin-left: 25px; max-width: 90%;">
...
The organization plans to extend to the rest of the state and even the country in the following months and years and already has an expansion plan in place.
          ...
          <div class="columns small-12 medium-4 large-7">
                <br>
                <br>
                <img src="../assets/ourcause/calkins.jpg" width="60%" style="left:235px; position: relative;" id="calkinsphoto"/>
          </div>
