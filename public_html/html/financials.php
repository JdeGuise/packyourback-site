	...
	<footer class="footer">
	  <div class="after">
		<div class="row fwrapper">
			<div class="columns small-12 medium-6 large-3" id="footer1">
			  <div class="content">
		  ...
		  <section class="subscribe">
			...
			<div class="columns small-12 medium-6 large-3" id="footer3">
			<br>
			<br>
			  <div class="content">
				<h4>Who We Are</h4>
...
<!--               <button class="footer_buttons">Privacy Policy</button>
 -->            <br/>
		  ...
		  <div class="columns small-12 medium-6 large-3" id="footer4">
		  <br>
		  <br>
				<div class="content">
				<h4>Get Involved</h4>
